...
public class daftar_proyek_ui extends javax.swing.JFrame {
    ...
    private void loadData() {
        ...
        try {
            ...
            while (rs.next()) {
                comboBox.addElement(rs.getString("Nama_Teknisi"));
            }
            comboPic.setModel(comboBox);
            con.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(daftar_proyek_ui.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
