 ...
 * @author BYTECOM
 */
public class daftar_PIC_SRE_ui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textNamaPICSRE = new javax.swing.JTextField();
        textHp = new javax.swing.JTextField();
        btnSave = new javax.swing.JButton();
        jScrollPane5 = new javax.swing.JScrollPane();
        tablePICSRE = new javax.swing.JTable();
        ...
        jnama_proyek.setText("Nama PIC SRE:");
        ...
        tablePICSRE.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][] {
                        { null, null, null },
                        { null, null, null },
                        { null, null, null },
        ...
        tablePICSRE.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablePICSREMouseClicked(evt);
            }
        });
        jScrollPane5.setViewportView(tablePICSRE);
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(textHp, javax.swing.GroupLayout.PREFERRED_SIZE, 126,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGroup(jPanel1Layout
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(textId, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jlokasi)
                                        .addComponent(textHp, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jnama_proyek)
                                        .addComponent(textNamaPICSRE, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel2)
                                        .addComponent(textCari, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnCari))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 23,
                                        Short.MAX_VALUE)
                                .addComponent(jScrollPane5, javax.swing.GroupLayout.PREFERRED_SIZE, 193,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)));
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnCariActionPerformed
        ...
        model.addColumn("ID");
        model.addColumn("Nama PIC SRE");
        model.addColumn("No HP");
        tablePICSRE.setModel(model);
        try {
            java.sql.Connection con;
            PreparedStatement p;
            String sql = "SELECT * FROM pic_sre WHERE Nama_PIC_SRE LIKE '%" + cari + "%'";
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
        String nt = textNamaPICSRE.getText();
        ...
        if (nt.equals("") && hp.equals("")) {
            ...
            try {
                ...
                p = (PreparedStatement) con
                        .prepareStatement("insert into pic_sre (Nama_PIC_SRE, No_Handphone) values(?,?)");
                p.setString(1, textNamaPICSRE.getText());
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditActionPerformed
        // TODO add your handling code here:
        String newnt = textNamaPICSRE.getText();
        String newhp = textHp.getText();

        int baris = tablePICSRE.getSelectedRow();
        String nt = tablePICSRE.getValueAt(baris, 1).toString();
        String hp = tablePICSRE.getValueAt(baris, 2).toString();
        ...
        if (newnt.equals(nt) && newhp.equals(hp)) {
            ...
            try {
                ...
                con = (Connection) koneksi.getKoneksi();
                p = (PreparedStatement) con
                        .prepareStatement("update pic_sre set Nama_PIC_SRE=?, No_Handphone=? where ID=?");
                p.setString(1, newnt);
                p.setString(2, newhp);
                p.setString(3, tablePICSRE.getValueAt(baris, 0).toString());
                p.executeUpdate();
    ...
    private void btnDellActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDellActionPerformed
        // TODO add your handling code here:
        int baris = tablePICSRE.getSelectedRow();
        String id = tablePICSRE.getValueAt(baris, 0).toString();
        try {
            java.sql.Connection con;
            PreparedStatement p;
            con = (Connection) koneksi.getKoneksi();
            p = (PreparedStatement) con.prepareStatement("delete from pic_sre where ID=?");
            p.setString(1, id);
            p.executeUpdate();
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnClearActionPerformed
        // TODO add your handling code here:
        textId.setText("");
        textNamaPICSRE.setText("");
        textHp.setText("");
        textCari.setText("");
    }// GEN-LAST:event_btnClearActionPerformed

    private void tablePICSREMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tablePICSREMouseClicked
        // TODO add your handling code here:
        int baris = tablePICSRE.getSelectedRow();
        textId.setText(tablePICSRE.getValueAt(baris, 0).toString());
        textNamaPICSRE.setText(tablePICSRE.getValueAt(baris, 1).toString());
        textHp.setText(tablePICSRE.getValueAt(baris, 2).toString());
    }// GEN-LAST:event_tablePICSREMouseClicked
    ...
    private void loadTable() {
        ...
        try {
            ...
            String sql = "SELECT * FROM pic_sre";
            ResultSet rs = (ResultSet) stmt.executeQuery(sql);
            while (rs.next()) {
                model.addRow(new Object[] { rs.getString("ID"), rs.getString("Nama_PIC_SRE"),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(daftar_PIC_SRE_ui.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new daftar_PIC_SRE_ui().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tablePICSRE;
    private javax.swing.JTextField textCari;
    private javax.swing.JTextField textHp;
    private javax.swing.JTextField textId;
    private javax.swing.JTextField textNamaPICSRE;
